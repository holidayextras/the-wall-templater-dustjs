...
module.exports = function(dust) {
  ...
  * @example {@_checkIfCarParking upgradeName=content.name /} returns true if Car Parking otherwise false
  */
  ...
  dust.helpers._isCarParking = function(chunk, context, bodies, params) {
    ...
    return params.upgradeName.toLowerCase().replace(/ /g, "") === 'carparking' ? true : false;
  };
